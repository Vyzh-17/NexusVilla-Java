...
public class AdminGUI extends JFrame {
    ...
    private final int adminId, communityId;
    private String communityName;
    
    public AdminGUI(int adminId, int communityId) {
        this.adminId = adminId; 
        this.communityId = communityId;
        this.communityName = getCommunityName(); // Get community name from database
        initializeFrame();
        setupUI();
        setVisible(true);
    }
    ...
    private void initializeFrame() {
        setTitle("NexusVilla - Admin Dashboard");
        setSize(1300, 800);
    ...
    private JPanel createHeader() {
        ...
        communityLabel.setBackground(new Color(59, 130, 246));
    ...
    private JPanel createSidebar() {
        ...
        userPanel.setBorder(BorderFactory.createCompoundBorder(
            ...
            BorderFactory.createEmptyBorder(15, 20, 15, 20) // Fixed: createEmptyBorder instead of createEmptyPadding
        ));
        ...
        JLabel userInfo = new JLabel("<html><b style='color:#1e293b;font-size:12px;'>Administrator</b><br>" +
        ...
        // Navigation - Removed Dashboard and Settings
        String[] menuItems = {
            "Post Notice", "View Notices", 
            "All Visitors", "Verified Visitors", "Complaints",
            "Logout"
        };
    ...
    private JPanel createWelcomeSection() {
        ...
        JLabel subtitle = new JLabel("Managing " + communityName);
    ...
    private JPanel createStatsGrid() {
        ...
        grid.add(createStatCard("Total Residents", "156", new Color(16, 185, 129), "👥"));
        grid.add(createStatCard("Today's Visitors", "23", new Color(59, 130, 246), "🚶"));
        grid.add(createStatCard("Active Notices", "8", new Color(245, 158, 11), "📢"));
        grid.add(createStatCard("Pending Complaints", "5", new Color(239, 68, 68), "💬"));
    ...
    private JPanel createQuickActions() {
        ...
        actionsGrid.add(createActionCard("Post Notice", "", "📝"));
        actionsGrid.add(createActionCard("View Visitors", "", "👥"));
        actionsGrid.add(createActionCard("Manage Complaints", "", "💬"));
    ...
    private void handleNavigation(String text) {
        switch (text) {
            case "Post Notice":
                new PostNoticeFrame(svc, communityId);
                break;
            case "View Notices":
                new ViewNoticesFrame(communityId);
                break;
            case "All Visitors":
                new ViewVisitorLogFrame("admin", adminId);
                break;
            case "Verified Visitors":
                new ViewVisitorLogFrame("adminUsed", adminId);
                break;
            case "Complaints":
                new ViewComplaintsFrame();
                break;
            case "Logout":
                dispose();
                new LoginFrame();
